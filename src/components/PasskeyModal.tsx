            ...
            <div
              className={`flex h-9 w-9 items-center justify-center rounded-xl border ${
                isEditor
                  ...
                  : 'bg-cyan-100 dark:bg-cyan-600/20 text-cyan-700 dark:text-cyan-400 border-cyan-200 dark:border-cyan-500/30'
              }`}
            >
          ...
          {!isEditor ? (
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-sky-700 dark:text-sky-200 block">
                  Team Passkey
                </label>
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-sky-600 dark:hover:text-sky-100 cursor-pointer"
                  >
              ...
              <div className="pt-2 flex items-center justify-between gap-3">
                ...
                <button
                  type="submit"
                  className="flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-cyan-600 to-purple-600 px-4 py-2 text-xs font-bold text-white shadow-sm hover:from-cyan-500 hover:to-purple-500 transition-all cursor-pointer whitespace-nowrap"
                >
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-xl bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-200/80 dark:border-emerald-800/40 text-xs text-emerald-900 dark:text-emerald-200 flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-sky-600 dark:text-sky-200 text-[11px] leading-relaxed">
              ...
              <div className="flex items-center justify-between pt-2">
                <button
                  ...
                  className="flex items-center gap-1.5 text-xs text-sky-600 dark:text-[#4a6a8a] hover:text-sky-900 dark:hover:text-sky-50 transition-colors cursor-pointer"
                >
            ...
            <form onSubmit={handleChangeKey} className="space-y-3">
              <div className="space-y-1">
                <label className="text-[11px] font-semibold text-sky-700 dark:text-sky-200">
                  Current Passkey
                </label>
                <input
                  type="password"
              ...
              <div className="pt-2 flex items-center justify-between">
                <button
                  ...
                  className="text-xs text-slate-500 hover:text-sky-800 dark:hover:text-sky-100 cursor-pointer"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  className="rounded-xl bg-cyan-600 hover:bg-cyan-500 px-3.5 py-1.5 text-xs font-semibold text-white transition-colors cursor-pointer"
                >
                  Save New Passkey
                </button>
              </div>
