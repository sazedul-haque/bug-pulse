      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2.5 sm:px-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="hidden md:block text-[11px] text-slate-400 dark:text-slate-500 mt-0.5">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium transition-all cursor-pointer ${
              currentView === 'analytics'
                ? 'bg-white dark:bg-indigo-600 text-indigo-600 dark:text-white shadow-2xs font-semibold'
        ...
        <div className="flex items-center gap-1.5">
          ...
          <div className="relative hidden md:block">
            ...
            <input
              ...
              className="w-36 lg:w-48 rounded-lg bg-slate-100 dark:bg-slate-900 py-1.5 pl-8 pr-3 text-xs text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 border border-slate-200 dark:border-slate-800 focus:border-indigo-500 focus:outline-none transition-all"
            />
          </div>
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900 text-slate-600 dark:text-slate-300 hover:bg-slate-200/80 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white transition-all cursor-pointer"
          >
            {theme === 'dark' ? (
          ...
          {isEditor && (
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-500 px-3 py-1.5 text-xs font-semibold text-white shadow-xs transition-all cursor-pointer"
            >
